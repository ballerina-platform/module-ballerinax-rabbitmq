...
public client class Client {
    ...
    isolated remote function queueDeclare(string name, QueueConfig? config = ()) returns string|Error? {
    ...
    # + return - A `rabbitmq:Error` if an I/O error is encountered or else `()`
    isolated remote function basicPublish(@untainted byte[] messageContent, string routingKey,
