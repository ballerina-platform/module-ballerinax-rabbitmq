...
public client class Client {
  ...
  # Initializes a `rabbitmq:Client` object.
   ...
   public isolated function init(ConnectionConfig connectionData = {}) {
    ...
    public isolated remote function queueDeclare(string name, QueueConfig? config = ()) returns string|Error? {
    ...
    public isolated remote function exchangeDeclare(string name,
    ...
    # + return - A `rabbitmq:Error` if an I/O error is encountered or else `()`
    public isolated remote function basicPublish(@untainted byte[] messageContent, string routingKey,
    ...
    # + closeMessage - A message indicating the reason for closing the channel
    # + return - A `rabbitmq:Error` if an I/O error is encountered or else `()`
    public isolated function 'abort(int? closeCode = (), string? closeMessage = ()) returns Error? {
...
isolated function nativeQueueDeclare(string name, QueueConfig? config, handle amqpChannel) returns string|Error? =
@java:Method {
    name: "queueDeclare",
    'class: "org.ballerinalang.messaging.rabbitmq.util.ChannelUtils"
} external;
