...
public client class Channel {
    ...
    public isolated remote function queueDeclare(QueueConfiguration? queueConfig = ()) returns string|Error? {
    ...
    public isolated remote function exchangeDeclare(ExchangeConfiguration exchangeConfig) returns Error? {
    ...
    # + return - A `rabbitmq:Error` if an I/O error is encountered or else `()`
    public isolated remote function queueBind(string queueName, string exchangeName, string bindingKey) returns Error? {
    ...
    # + return - A `rabbitmq:Error` if an I/O error is encountered or else `()`
    public isolated remote function basicPublish(@untainted MessageContent messageContent, string routingKey,
    ...
    # + return - A `rabbitmq:Error` if an I/O error is encountered or else `()`
    public isolated remote function queueDelete(string queueName, boolean ifUnused = false, boolean ifEmpty = false)
                        returns Error? {
    ...
    # + return - A `rabbitmq:Error` if an I/O error is encountered or else `()`
    public isolated remote function exchangeDelete(string exchangeName) returns Error? {
    ...
    # + return - A `rabbitmq:Error` if an I/O error is encountered or else `()`
    public isolated remote function queuePurge(string queueName) returns Error? {
    ...
    public isolated remote function basicGet(string queueName, AcknowledgementMode ackMode) returns Message|Error {
    ...
    public isolated function getConnection() returns Connection|Error {
    ...
    # + return - A `rabbitmq:Error` if an I/O error is encountered or else `()`
    public isolated function close(int? closeCode = (), string? closeMessage = ()) returns Error? {
    ...
    # + closeMessage - A message indicating the reason for closing the channel
    # + return - A `rabbitmq:Error` if an I/O error is encountered or else `()`
    public isolated function abortChannel(int? closeCode = (), string? closeMessage = ()) returns Error? {
...
isolated function createChannel(handle connection, Channel channelObj) returns handle =
@java:Method {
    'class: "org.ballerinalang.messaging.rabbitmq.util.ChannelUtils"
} external;

isolated function nativeQueueDeclare(QueueConfiguration? config, handle amqpChannel) returns string|Error? =
@java:Method {
    name: "queueDeclare",
    'class: "org.ballerinalang.messaging.rabbitmq.util.ChannelUtils"
} external;

isolated function nativeExchangeDeclare(ExchangeConfiguration config, handle amqpChannel) returns Error? =
@java:Method {
...
isolated function nativeBasicPublish(MessageContent messageContent, string routingKey, string exchangeName,
...
isolated function nativeChannelClose(int? closeCode, string? closeMessage, handle amqpChannel) returns Error? =
@java:Method {
    name: "close",
    'class: "org.ballerinalang.messaging.rabbitmq.util.ChannelUtils"
} external;

isolated function nativeChannelAbort(int? closeCode, string? closeMessage, handle amqpChannel) returns Error? =
@java:Method {
    name: "abort",
    'class: "org.ballerinalang.messaging.rabbitmq.util.ChannelUtils"
} external;

isolated function nativeGetConnection(handle amqpChannel) returns Connection|Error =
@java:Method {
    name: "getConnection",
    'class: "org.ballerinalang.messaging.rabbitmq.util.ChannelUtils"
} external;
