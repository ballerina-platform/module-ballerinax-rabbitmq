...
import static io.ballerina.stdlib.rabbitmq.plugin.CompilerPluginTestUtils.EXPECTED_SOURCES;
import static io.ballerina.stdlib.rabbitmq.plugin.CompilerPluginTestUtils.RESOURCE_DIRECTORY;
import static io.ballerina.stdlib.rabbitmq.plugin.RabbitmqCodeTemplate.NODE_LOCATION;
...
public class CodeSnippetGenerationCodeActionTest extends AbstractCodeActionTest {
    ...
    private CodeActionInfo getExpectedCodeAction(String filePath, int line, int offset) {
        ...
        codeAction.setProviderName("RABBITMQ_120/ballerinax/rabbitmq/ADD_REMOTE_FUNCTION_CODE_SNIPPET");
        return codeAction;
    }
}
