...
const DATA_BINDING_STRING_LISTENER_REQUEST_QUEUE = "StringListenerRequestQueue";
const DATA_BINDING_INT_LISTENER_REQUEST_QUEUE = "IntListenerRequestQueue";
const DATA_BINDING_DECIMAL_LISTENER_REQUEST_QUEUE = "DecimalListenerRequestQueue";
const DATA_BINDING_FLOAT_LISTENER_REQUEST_QUEUE = "FloatListenerRequestQueue";
const DATA_BINDING_BOOLEAN_LISTENER_REQUEST_QUEUE = "BooleanListenerRequestQueue";
const DATA_BINDING_MAP_LISTENER_REQUEST_QUEUE = "MapListenerRequestQueue";
const DATA_BINDING_RECORD_LISTENER_REQUEST_QUEUE = "RecordListenerRequestQueue";
const DATA_BINDING_TABLE_LISTENER_REQUEST_QUEUE = "TableListenerRequestQueue";
const DATA_BINDING_XML_LISTENER_REQUEST_QUEUE = "XmlListenerRequestQueue";
const DATA_BINDING_JSON_LISTENER_REQUEST_QUEUE = "JsonListenerRequestQueue";
const DATA_BINDING_STRING_PAYLOAD_LISTENER_QUEUE = "StringPayloadListenerQueue";
const DATA_BINDING_INT_PAYLOAD_LISTENER_QUEUE = "IntPayloadListenerQueue";
const DATA_BINDING_DECIMAL_PAYLOAD_LISTENER_QUEUE = "DecimalPayloadListenerQueue";
const DATA_BINDING_FLOAT_PAYLOAD_LISTENER_QUEUE = "FloatPayloadListenerQueue";
const DATA_BINDING_BOOLEAN_PAYLOAD_LISTENER_QUEUE = "BooleanPayloadListenerQueue";
const DATA_BINDING_MAP_PAYLOAD_LISTENER_QUEUE = "MapPayloadListenerQueue";
const DATA_BINDING_RECORD_PAYLOAD_LISTENER_QUEUE = "RecordPayloadListenerQueue";
const DATA_BINDING_TABLE_PAYLOAD_LISTENER_QUEUE = "TablePayloadListenerQueue";
const DATA_BINDING_XML_PAYLOAD_LISTENER_QUEUE = "XmlPayloadListenerQueue";
const DATA_BINDING_JSON_PAYLOAD_LISTENER_QUEUE = "JsonPayloadListenerQueue";
const DATA_BINDING_STRING_PAYLOAD_LISTENER_REQUEST_QUEUE = "StringPayloadListenerRequestQueue";
const DATA_BINDING_INT_PAYLOAD_LISTENER_REQUEST_QUEUE = "IntPayloadListenerRequestQueue";
const DATA_BINDING_DECIMAL_PAYLOAD_LISTENER_REQUEST_QUEUE = "DecimalPayloadListenerRequestQueue";
const DATA_BINDING_FLOAT_PAYLOAD_LISTENER_REQUEST_QUEUE = "FloatPayloadListenerRequestQueue";
const DATA_BINDING_BOOLEAN_PAYLOAD_LISTENER_REQUEST_QUEUE = "BooleanPayloadListenerRequestQueue";
const DATA_BINDING_MAP_PAYLOAD_LISTENER_REQUEST_QUEUE = "MapPayloadListenerRequestQueue";
const DATA_BINDING_RECORD_PAYLOAD_LISTENER_REQUEST_QUEUE = "RecordPayloadListenerRequestQueue";
const DATA_BINDING_TABLE_PAYLOAD_LISTENER_REQUEST_QUEUE = "TablePayloadListenerRequestQueue";
const DATA_BINDING_XML_PAYLOAD_LISTENER_REQUEST_QUEUE = "XmlPayloadListenerRequestQueue";
...
const DATA_BINDING_BYTES_PUBLISH_QUEUE = "BytesPublishQueue";
...
function setup() returns error? {
    ...
    if clientObj is Client {
        ...
        check clientObj->queueDeclare(DATA_BINDING_STRING_LISTENER_REQUEST_QUEUE);
        check clientObj->queueDeclare(DATA_BINDING_INT_LISTENER_REQUEST_QUEUE);
        check clientObj->queueDeclare(DATA_BINDING_DECIMAL_LISTENER_REQUEST_QUEUE);
        check clientObj->queueDeclare(DATA_BINDING_FLOAT_LISTENER_REQUEST_QUEUE);
        check clientObj->queueDeclare(DATA_BINDING_BOOLEAN_LISTENER_REQUEST_QUEUE);
        check clientObj->queueDeclare(DATA_BINDING_MAP_LISTENER_REQUEST_QUEUE);
        check clientObj->queueDeclare(DATA_BINDING_RECORD_LISTENER_REQUEST_QUEUE);
        check clientObj->queueDeclare(DATA_BINDING_TABLE_LISTENER_REQUEST_QUEUE);
        check clientObj->queueDeclare(DATA_BINDING_XML_LISTENER_REQUEST_QUEUE);
        check clientObj->queueDeclare(DATA_BINDING_JSON_LISTENER_REQUEST_QUEUE);
...
function setup2(Client clientObj) returns error? {
    ...
    check clientObj->queueDeclare(DATA_BINDING_STRING_PAYLOAD_LISTENER_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_INT_PAYLOAD_LISTENER_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_DECIMAL_PAYLOAD_LISTENER_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_FLOAT_PAYLOAD_LISTENER_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_BOOLEAN_PAYLOAD_LISTENER_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_MAP_PAYLOAD_LISTENER_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_RECORD_PAYLOAD_LISTENER_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_TABLE_PAYLOAD_LISTENER_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_XML_PAYLOAD_LISTENER_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_JSON_PAYLOAD_LISTENER_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_STRING_PAYLOAD_LISTENER_REQUEST_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_INT_PAYLOAD_LISTENER_REQUEST_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_DECIMAL_PAYLOAD_LISTENER_REQUEST_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_FLOAT_PAYLOAD_LISTENER_REQUEST_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_BOOLEAN_PAYLOAD_LISTENER_REQUEST_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_MAP_PAYLOAD_LISTENER_REQUEST_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_RECORD_PAYLOAD_LISTENER_REQUEST_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_TABLE_PAYLOAD_LISTENER_REQUEST_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_XML_PAYLOAD_LISTENER_REQUEST_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_JSON_PAYLOAD_LISTENER_REQUEST_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_RANDOM_PAYLOAD_MESSAGE_LISTENER_QUEUE);
    check clientObj->queueDeclare(DATA_BINDING_RANDOM_PAYLOAD_MESSAGE_LISTENER_REQUEST_QUEUE);
    check setup3(clientObj);
}

function setup3(Client clientObj) returns error? {
    ...
    check clientObj->queueDeclare(CONSTRAINT_VALID_RECORD_QUEUE);
    check clientObj->queueDeclare(CONSTRAINT_DISABLED_VALIDATION_QUEUE);
}
